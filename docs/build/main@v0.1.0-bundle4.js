...
window.__etcpack__bundleSrc__['39']=function(){
  ...
  bar_simple: function bar_simple() {
    return window.__etcpack__getLazyBundle('./build/main@v0.1.0-bundle5.js','40');
  }
};
